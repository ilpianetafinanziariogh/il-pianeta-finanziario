      ...
      <section className="container py-16">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-zinc-300">
             Organizza con noi la tua esperienza formativa in barca o ricevi i contenuti direttamente a casa.
          </p>
        ...
        <div className="grid gap-6 max-w-4xl mx-auto">
          ...
          <Card className="overflow-hidden">
            <CardHeader>
              ...
              <CardDescription>Viaggi formativi per costruire libertà, metodo e visione.Gli investimenti a lungo termine non sono per pochi.Sono per chiunque voglia prendersi responsabilità del proprio futuro,anche senza esperienza, anche vivendo fuori dagli schemi.</CardDescription>
            </CardHeader>
